...
export default function Ticket2(){
    return(
        <card className={poppins.className} class="flex flex-col justify-center align-center text-[17px] mt-12 p-3 w-[237px] hover:scale-105 hover:duration-500 hover:drop-shadow-2xl">
            <Image src="/ticket2.jpeg" width={226} height={401} className=" border-b-2 pb-4 border-[#818A97] border-dashed"/>
            <div className="">
                <div className="p-4 text-[17px] flex justify-center ">Sacramento River Cats</div>
                <div className={poppinsS.className} >
                    ...
                    <div className="scoreH p-2 text-[14px] flex justify-center text-[#DFDFDF] break-normal text-center">Sutter Health Park, Sacramento, California</div>
                </div>
                <div className="flex justify-center align-center item-center">
                    <button className=" text-[12.73px] text-white bg-black p-3 px-10 text-center  hover-bg-blackhover">Orange Collection</button>
                </div>
            </div>
        </card>
    )
